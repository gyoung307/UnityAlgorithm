...
public class SGSinWaveShot : SGBaseShot
{
    ...
    public float waveRangSize = 40f;
    public float waveSpeed = 10f;
    public bool waveInverse = false;

    public float betweenAngle = 40f;
    ...
    protected virtual void Update()
    {
        ...
        while (delayTimer < 0)
        {
            for (int i = 0; i < wayNum; i++)
            {
                ...
                ShotProjectile(projectile, projectileSpeed, angle , false , null , 0f, true, waveSpeed , waveRangSize, waveInverse);
